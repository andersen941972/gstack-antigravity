...
J:/myproject/gstack_antigravity/gstack/bin/gstack-learnings-search --limit 20 2>/dev/null || echo "No learnings yet."
```
...
```bash
eval "$(J:/myproject/gstack_antigravity/gstack/bin/gstack-slug 2>/dev/null)"
J:/myproject/gstack_antigravity/gstack/bin/gstack-learnings-search --query "USER_QUERY" --limit 20 2>/dev/null || echo "No matches."
```
...
```bash
eval "$(J:/myproject/gstack_antigravity/gstack/bin/gstack-slug 2>/dev/null)"
J:/myproject/gstack_antigravity/gstack/bin/gstack-learnings-search --limit 100 2>/dev/null
```
...
```bash
eval "$(J:/myproject/gstack_antigravity/gstack/bin/gstack-slug 2>/dev/null)"
J:/myproject/gstack_antigravity/gstack/bin/gstack-learnings-search --limit 50 2>/dev/null
```
...
```bash
J:/myproject/gstack_antigravity/gstack/bin/gstack-learnings-log '{"skill":"learn","type":"TYPE","key":"KEY","insight":"INSIGHT","confidence":N,"source":"user-stated","files":["FILE1"]}'
```