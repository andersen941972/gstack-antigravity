---
description: retro - Weekly engineering retrospective. Analyzes commit history, work patterns,
---
// turbo-all
...
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-learnings-log '{"skill":"retro","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
```bash
DISCOVER_BIN=""
[ -x C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-global-discover
