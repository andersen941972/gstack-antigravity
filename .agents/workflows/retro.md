...
```bash
J:/myproject/gstack_antigravity/gstack/bin/gstack-learnings-log '{"skill":"retro","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
```bash
DISCOVER_BIN=""
[ -x J:/myproject/gstack_antigravity/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=J:/myproject/gstack_antigravity/gstack/bin/gstack-global-discover
