---
description: gstack-upgrade - Upgrade gstack to the latest version. Detects global vs vendored install,
---
// turbo-all
...
[ -z "$_AUTO" ] && _AUTO=$(C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-config get auto_upgrade 2>/dev/null || true)
...
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-config set auto_upgrade true
```
...
**If "Never ask again":**
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-config set update_check false
```
Tell user: "Update checks disabled. Run `C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-config set update_check true` to re-enable."
...
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-update-check --force 2>/dev/null || \
