...
[ -z "$_AUTO" ] && _AUTO=$(J:/myproject/gstack_antigravity/gstack/bin/gstack-config get auto_upgrade 2>/dev/null || true)
...
```bash
J:/myproject/gstack_antigravity/gstack/bin/gstack-config set auto_upgrade true
```
...
**If "Never ask again":**
```bash
J:/myproject/gstack_antigravity/gstack/bin/gstack-config set update_check false
```
Tell user: "Update checks disabled. Run `J:/myproject/gstack_antigravity/gstack/bin/gstack-config set update_check true` to re-enable."
...
```bash
J:/myproject/gstack_antigravity/gstack/bin/gstack-update-check --force 2>/dev/null || \
