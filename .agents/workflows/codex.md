---
description: codex - OpenAI Codex CLI wrapper — three modes. Code review: independent diff review via
---
// turbo-all
...
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-review-log '{"skill":"codex-review","timestamp":"TIMESTAMP","status":"STATUS","gate":"GATE","findings":N,"findings_fixed":N,"commit":"'"$(git rev-parse --short HEAD)"'"}'
```
