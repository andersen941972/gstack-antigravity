---
description: investigate - Systematic debugging with root cause investigation. Four phases: investigate,
---
// turbo-all
...
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-learnings-log '{"skill":"investigate","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
