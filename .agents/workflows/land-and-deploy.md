...
```bash
J:/myproject/gstack_antigravity/gstack/bin/gstack-review-read 2>/dev/null
```
...
```bash
cat J:/myproject/gstack_antigravity/gstack/review/checklist.md 2>/dev/null || echo "Checklist not found"
```
...
```bash
eval $(J:/myproject/gstack_antigravity/gstack/bin/gstack-diff-scope $(gh pr view --json baseRefName -q .baseRefName 2>/dev/null || echo main) 2>/dev/null)
