---
description: land-and-deploy - Land and deploy workflow. Merges the PR, waits for CI and deploy,
---
// turbo-all
...
```bash
C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-review-read 2>/dev/null
```
...
```bash
cat C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/review/checklist.md 2>/dev/null || echo "Checklist not found"
```
...
```bash
eval $(C:/Users/naoki/.gemini/antigravity/skills/gstack-antigravity/gstack/bin/gstack-diff-scope $(gh pr view --json baseRefName -q .baseRefName 2>/dev/null || echo main) 2>/dev/null)
